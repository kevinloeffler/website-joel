<section class="section-wrapper" id="positionen">

    <h2 class="title">Positionen</h2>
    {#each positions as position}
        <Position title={position.title} text={position.text} />
    {/each}
    ...
    const positions: {title: string, text: string}[] = [
        {
            ...
            text: 'Wir sind Teil Europas.'
                    ...
                    Denn unsere Wirtschaft ist auf ein klares Abkommen angewiesen und die Bilateralen I und II erordieren zunehmends. Dringender Handlungsbedarf ist notwendig.',
        },
        {
            title: 'Wirtschaft',
            text: 'Ein nachhaltiger und attraktiver Standort Schweiz.  '
                    ...
                    wird es langfristig auch unsere Wirtschaft florieren. Mehr dazu im Abschnitt Klima. Weiterhin müssen bürokratische Hürden möglichst klein gehalten werden. Start-ups sollen schnell und unkompliziert mit ihrer Arbeit beginnen können.
                    ...
                    Insgesamt müssen wir uns stetig in Erinnerung rufen, dass wir alle die Wirtschaft sind. Interessen der Unternehmen, Arbeitnehmenden, Konsument:innen, etc. müssen alle gleichwertig berücksichtigt werden.' ,
        },
        {
            title: 'Klima',
            text: ' Wir müssen unserer wichtigesten Ressource, dem Planeten, Sorge tragen.'
                    ...
                    Klimafreundliche Alternativen werden attraktiver, sowohl für Konsument:innen, wie auch Produzent:innen. Anreize für technologische Fortschritte und deren Implementierung werden gestärkt.
        ...
        },
        {
            ...
            text: 'Alle für einen, einer für alle. '
                    'Alle haben eine respektvolle und gleichwertige Behandlung verdient. Egal ob Sexualität, Geschlecht oder Herkunft, der Staat muss alle gleich behandeln und sich darum bemühen, dass alle möglichst dieselben Möglichkeiten erhalten.
                    Nebst der eindeutigen rechtlichen Gleichbehandlung gehört die Chancengleichheit zu einem wichtigen Eckpfeil. Ein starkes Bildungssystem ist essentiell um Unterschiede in den persönlichen Voraussetzungen zu minimieren.' ,
        },
        {
            title: 'Sozial',
            text: 'Die Stärke der Schweiz misst sich am Wohl der Ärmsten.'
                    ...
                    die Chance einer guten und finanziell anständigen Arbeit ermöglicht werden.   '
,
        },
        {
            title: 'Migration',
